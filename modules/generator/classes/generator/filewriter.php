...
class Generator_Filewriter {
    ...
    public function write($mod=1) {
        ...
        switch ($mod) {
            case 1 :
                $dirpath = DOCROOT . "application" . DIRECTORY_SEPARATOR . "classes" . DIRECTORY_SEPARATOR . "model" . DIRECTORY_SEPARATOR;
                break;
            case 2 :
                $dirpath = DOCROOT . "application" . DIRECTORY_SEPARATOR . "views" . DIRECTORY_SEPARATOR . "forms" . DIRECTORY_SEPARATOR;
                break;
            case 3 :
                $dirpath = DOCROOT . "application" . DIRECTORY_SEPARATOR . "classes" . DIRECTORY_SEPARATOR . "controller" . DIRECTORY_SEPARATOR;
                break;
            case 4 :
                $dirpath = DOCROOT . "assets" . DIRECTORY_SEPARATOR;
                break;
            case 5 :
                $dirpath = DOCROOT . "assets" . DIRECTORY_SEPARATOR . "css" . DIRECTORY_SEPARATOR;
                break;
            case 6 :
                $dirpath = DOCROOT . "assets" . DIRECTORY_SEPARATOR . "js" . DIRECTORY_SEPARATOR;
                break;
            case 7 :
                $dirpath = DOCROOT . "assets" . DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR;
                break;
        }
