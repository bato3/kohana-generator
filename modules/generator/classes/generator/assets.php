...
class Generator_Assets {
    ...
    public static function generate() {
        ...
        $writer->addRow("html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,
            ...
            border:0;font-size:100%;font:inherit;vertical-align:baseline;}article,aside,details,figcaption,
            figure,footer,header,hgroup,menu,nav,section{display:block;}body{line-height:1;}ol,ul{list-style:none;}
