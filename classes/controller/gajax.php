    ...
    public function action_generate() 
    {
        ...
        if(class_exists($class))
        {
            if (get_parent_class($class) === "Generator_Item_Abstract_Item") 
            {
                ...
                $view->result = true;
                $view->errors = $generator->get_errors();
                $view->skipped_files = $generator->get_skipped_files();
                $view->skipped_dirs = $generator->get_skipped_dirs();
                $view->generated_files = $generator->get_generated_files();
                $view->generated_dirs = $generator->get_generated_dirs();    
            }
            else
            {
                $view = View::factory("generator/error");
